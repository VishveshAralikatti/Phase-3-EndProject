...
public class Assignment002Demo {
	...
	public void assignment002Post() {
		...
		File file = new File("D:\\\\Mphasis\\\\SL\\\\SL\\\\src\\\\main\\\\resource\\\\Data.json");
	...
	public void assignment002Put() {
		File file = new File(
				"D:\\Mphasis\\SL\\SL\\src\\main\\resource\\data1.json");
		 RestAssured.given().baseUri("https://petstore.swagger.io/v2/pet/").contentType(ContentType.JSON)
